...
import java.awt.Frame;
	...
	public class ConsultaClinicas implements WindowListener, ActionListener
	{
		Frame ventana = new Frame("Consulta Clinicas");
		...
		String usuario;
		public ConsultaClinicas(String usuario)
		{
			...
			txtArea.append(modelo.consultarClinicas(connection));
		...
		public static final String DEST = "consultaClinicas.pdf";
		@Override
